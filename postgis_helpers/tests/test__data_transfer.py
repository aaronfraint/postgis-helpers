...
from postgis_helpers.tests.fixtures import (
    DataForTest,
    database_1,
    database_2,
    test_csv_data,
...
@using(database1=database_1, database2=database_2, csv=test_csv_data)
...
@using(database1=database_1, database2=database_2, shp=test_shp_data)
